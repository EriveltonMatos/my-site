...
import { Award, BookOpen, LifeBuoy, Medal, Users } from "lucide-react";
        ...
        <ScrollFadeIn>
          <div className="max-w-4xl mx-auto text-center mb-16">
            <div className="inline-block p-3 bg-blue-100 rounded-2xl mb-6">
              <Medal className="w-10 h-10 text-blue-600" />
            </div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              A Agile Change preza pela atuação nesses 3 contextos, visando
              trazer uma completude no que se pode abordar à nível empresarial,
              seja Estratégico, Tático ou Operacional, sempre utilizando de
